...
class AuthGoogle extends React.Component{
    ...
    renderAuthButton(){
        if(this.props.isSignedIn){
            ...
            return <button onClick={()=>this.auth.signIn()} className={`btn btn-primary bg-white text-primary`} style={{ fontSize: "17px" }}><i class="fa-regular fa-user mx-2"></i>SIGN IN</button>
        }
    }
